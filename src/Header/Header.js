...
function Header() {
  ...
  useEffect(() => {
    ...
    axios
      .post(porturl + "/searchBookByType", { bookType })
      .then((result) => {
  ...
  return (
    <div className="header">
      <div className="combine">
        ...
        <form onSubmit={handleGsearch}>
          <select
            className="searchByType"
      ...
      {menuIcon && (
        <span>
          <MenuIcon
            ...
            className="menuIcon"
            onClick={() => {
              !showMenuIcon ? setShowMenuIcon(true) : setShowMenuIcon(false);
            }}
          />
        </span>
      )}
      <ul style={{ top: showMenuIcon ? "94px" : "-150px" }}>
        <li>
          <Link
            to="/about"
            onClick={() => {
              menuIcon && setShowMenuIcon(false);
            }}
          >
            {" "}
            About{" "}
